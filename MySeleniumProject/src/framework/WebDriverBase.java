...

{
	...
	public WebDriver getDriver() throws MalformedURLException {
		System.setProperty("webdriver.chrome.driver","C:\\seleniumdrivers\\Latest\\chromedriver.exe");
		 ...
		 * will just get the any // available one options.setCapability("resolution",
		 * "1024x768"); options.setCapability("build", "PraticeBuild");
		 * 
		 * options.setCapability("name", "Practicerun"+runNumber);
